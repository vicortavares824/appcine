      ...
      <div className="container">
        <div className="position-relative mb-5 ">
          {movies.slice(5, 6).map((movie) => {
            const modalId = `quickViewModal-${movie.id}`;
            return (
              <div
              ...
              >
                ...
                <MovieDetailsModal item={{ ...movie, genres: [] }} modalId={modalId} />
              </div>
            );
          })}
        </div>
              ...
              <div className="card-body">
                <div className="d-grid gap-2">
                  ...
                  <button
                    ...
                    data-bs-toggle="modal"
                    data-bs-target={`#quickViewModal-album-${movie.id}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                  ...
                  <MovieDetailsModal item={{ ...movie, genres: [] }} modalId={`quickViewModal-album-${movie.id}`} />
                </div>
              </div>
            </div>
          </div>
